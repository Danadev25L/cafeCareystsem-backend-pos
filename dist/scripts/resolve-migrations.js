...
async function resolveFailedMigration() {
    try {
        ...
        try {
            ...
            (0, child_process_1.execSync)('npx prisma migrate resolve --applied 20251120000000_add_order_tables', {
                stdio: 'inherit',
                env: process.env,
            });
            ...
            try {
                (0, child_process_1.execSync)('npx prisma migrate resolve --rolled-back 20251120000000_add_order_tables', {
                    stdio: 'inherit',
                    env: process.env,
                });
...
//# sourceMappingURL=resolve-migrations.js.map