...
router.post('/', (0, auth_middleware_1.authorize)(types_1.Role.CASHIER, types_1.Role.CAPTAIN, types_1.Role.ADMIN), (0, validation_middleware_1.validate)(order_controller_1.createOrderValidation), order_controller_1.createOrder);
